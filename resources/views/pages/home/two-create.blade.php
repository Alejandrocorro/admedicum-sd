<div class="has-padding-top-15">
    <div class="has-background-linear normal has-margin-bottom-25 align-items-center has-min-height-200 has-padding-bottom-40-desktop has-padding-top-40-desktop is-flex justify-center" data-aos="fade-up">
        <div class="column is-11 is-12-mobile has-padding-left-25-mobile">
            <h3 class="has-text-white font-w is-600 font-is-30"><strong class="has-text-white font-is-60 is-full-width" style="display: block;">2</strong>We create benefits and value for our clients, through</h2>
        </div>
    </div>
</div>

@fields('repeater_2_values', 'options')
    ...
    <div class="border-card-dark create"  data-aos="fade-up">
        <div class="is-flex wrap has-padding-5">
